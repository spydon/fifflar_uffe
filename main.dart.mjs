...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      GI: x0 => globalThis.Module_soloud._malloc(x0),
      ...
      HI: (x0,x1,x2) => globalThis.Module_soloud._addAudioDataStream(x0,x1,x2),
      HJ: (ms, c) =>
      ...
      II: x0 => globalThis.Module_soloud._free(x0),
      IJ: () => Date.now(),
      ...
      JI: () => globalThis.Module_soloud.HEAPU8,
      JJ: () => new Array(),
      ...
      KI: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => globalThis.Module_soloud._setBufferStream(x0,x1,x2,x3,x4,x5,x6,x7,x8),
      ...
      LH: x0 => x0.status,
      LI: (x0,x1) => globalThis.Module_soloud.getValue(x0,x1),
      LJ: x0 => x0.reason,
      ...
      MI: () => globalThis.Module_soloud._createWorkerInWasm(),
      MJ: x0 => x0.code,
      ...
      NG: x0 => x0.data,
      NH: x0 => x0.content,
      NI: x0 => globalThis.Module_soloud._setMixerOutputCallback(x0),
      ...
      OH: x0 => x0.document,
      OI: x0 => globalThis.Module_soloud._advanceMixerCaptureReadPosition(x0),
      ...
      SI: () => globalThis.Module_soloud.wasmWorker,
      ...
      TI: () => globalThis.Module_soloud._getVisualizationEnabled(),
      ...
      UI: (x0,x1,x2,x3,x4) => globalThis.Module_soloud._initEngine(x0,x1,x2,x3,x4),
      UJ: x0 => x0.close(),
      ...
      VI: () => globalThis.Module_soloud._dispose(),
      VJ: (x0,x1) => x0.send(x1),
      ...
      WH: x0 => x0.first(),
      WI: () => globalThis.Module_soloud._stopMixerCapture(),
      WJ: x0 => x0.readyState,
      ...
      XH: x0 => x0.next(),
      XI: () => globalThis.Module_soloud._isMixerCaptureRunning(),
      ...
      YG: x0 => x0.value,
      YH: x0 => x0.current(),
      YI: () => globalThis.Module_soloud._isInited(),
